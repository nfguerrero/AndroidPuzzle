 ...
 */
public class EasyLeaderboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.easy_leaderboard_main);
        mQueue = Volley.newRequestQueue(this);
        plistview = findViewById(R.id.easy_lv_puzzle);
        tlistview = findViewById(R.id.easy_lv_time);
        nlistview = findViewById(R.id.easy_lv_name);
        ...
        button = findViewById(R.id.back_button_from_easy_leaderboard);
    ...
    /**
     * This will load the leaderboard inputs for easy puzzles
     */
    private void getEasy() {
        String url = "http://coms-309-bs-6.misc.iastate.edu:8080/results/difficulty:3";
