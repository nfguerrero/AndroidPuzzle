 ...
 * Contains all activity associated with the puzzle creation page
 */
public class CreatePuzzleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            grid.setAdapter(new ImageConverter(this));
            grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    Intent intent = new Intent(getApplicationContext(), MainPuzzleActivity.class);
        ...
        button = findViewById(R.id.create_puzzle_back_button);
